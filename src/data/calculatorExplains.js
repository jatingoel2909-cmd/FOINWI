...
export const CALCULATOR_EXPLAINS = {
  ...
  "/ppf-calculator": {
    whyGenerated:
      "This is an educational PPF accumulation estimate using an annual contribution assumed deposited on or before 5 April of each financial year and a constant illustrative interest-rate assumption. It is not an official PPF passbook, an exact statutory maturity calculation, or tax advice.",
    keyInputs: [
      "Annual contribution — ₹500 to ₹1,50,000 in multiples of ₹50; the ₹1.5 lakh annual limit can include own-account and minor-account deposits where applicable",
      "Illustrative interest rate assumption — 7.1% is the latest rate verified for 1 July–30 September 2026 and is applied unchanged only for illustration",
      "Contribution years — this estimate models 15 contribution years as the standard scenario, which is not the same as statutory PPF maturity",
    ],
    ifInputsChange: [
      "A higher annual contribution typically increases the estimated PPF balance under the stated assumptions",
      "A higher illustrative rate typically increases the estimated PPF balance; Government-notified PPF rates can change, including quarter by quarter",
      "Depositing after 5 April is not modelled here and can reduce interest earned under official PPF rules",
    ],
    beginnerMistakes: [
      "Treating the estimated PPF balance as an exact amount that will be paid",
      "Assuming today's 7.1% rate will apply unchanged for 15 years",
      "Treating PPF interest as if it is added to the balance every month",
      "Treating 15 contribution years as 15 calendar years from the opening date",
      "Assuming this calculator estimates tax benefits or an 80C deduction for every visitor",
    ],
  ...
  "/retirement-calculator": {
    whyGenerated:
      "Under the assumptions entered, this illustration inflates current monthly expenses to retirement, then estimates a retirement-age corpus by modelling beginning-of-month withdrawals over the selected retirement years, with retirement-period inflation and post-retirement growth. Current retirement savings are grown to retirement with annual compounding only. Any illustrative monthly contribution is calculated separately to bridge a remaining funding gap.",
    keyInputs: [
      "Current monthly expenses — inflated to retirement using the pre-retirement inflation assumption",
      "Illustrated years in retirement — visitor-selected duration for the monthly withdrawal model",
      "Illustrative inflation and return assumptions before and during retirement",
      "Current retirement savings — grown to retirement with annual compounding; monthly contributions are not included in that projection",
    ],
    ifInputsChange: [
      "Higher pre-retirement inflation → higher modelled monthly expense at retirement",
      "Longer illustrated retirement years → typically a larger illustrative corpus",
      "Higher post-retirement return assumption → typically a smaller illustrative corpus",
      "Larger current savings → a smaller illustrative funding gap, or an illustrative surplus",
    ],
    beginnerMistakes: [
      "Treating the 25× simple comparison as the primary corpus estimate",
      "Assuming the projected value of current savings already includes future monthly contributions",
      "Using today's expenses without an inflation assumption",
      "Treating the illustration as a prediction rather than an educational estimate",
    ],
  ...
  "/nps-calculator": {
    whyGenerated:
      "This educational estimate projects a non-Government All Citizen Common Scheme Tier-I corpus from monthly contributions and an illustrative market-linked return. The 20%/80% exit split and illustrative annuity income are shown only for a normal-exit case at age 60 or later when projected corpus is above ₹12 lakh. This calculator does not compute tax. NPS contribution deductions and exit treatment depend on the applicable tax year and tax regime.",
    keyInputs: [
      "Monthly contribution — illustrated regular deposit",
      "Current age and illustrated exit age — contribution years for this scoped normal-exit case",
      "Illustrative market-linked return assumption — not a fixed NPS rate",
      "Illustrative annuity allocation — at least the 20% statutory minimum for this scope",
      "Illustrative annuity-rate assumption — not an ASP quote",
    ],
    ifInputsChange: [
      "Higher contribution → larger estimated projected corpus",
      "Longer horizon → more compounding in this simplified model",
      "Higher illustrative return assumption → higher projected corpus",
      "Higher annuity allocation → more of the corpus is treated as annuity purchase and less as the non-annuity portion",
    ],
    beginnerMistakes: [
      "Treating the estimated projected corpus as a fully withdrawable lump sum",
      "Treating 20% as the only allocation a subscriber may choose, rather than the statutory minimum for this scoped case",
      "Treating illustrative monthly annuity income as an ASP quote or a promised monthly income",
      "Assuming every NPS subscriber, exit type, or corpus size follows this 20%/80% split",
    ],
  ...
  "/home-loan-eligibility-calculator": {
    whyGenerated:
      "Under the assumptions entered, this illustration estimates an affordable EMI from monthly income, existing EMIs, and an illustrative affordability ratio, then converts that EMI into a loan amount. It does not determine a lender's loan-to-value limit for a property.",
    keyInputs: [
      "Monthly income — used with the illustrative affordability ratio",
      "Existing EMIs — reduce the modelled affordable EMI",
      "Interest rate and tenure — convert that EMI into an illustrative loan amount",
      "Illustrative affordability ratio — a visitor-editable share of income, not a lender or RBI rule",
    ],
    ifInputsChange: [
      "Higher income → typically a larger illustrative loan amount",
      "More existing EMIs → typically a smaller illustrative loan amount",
      "Longer tenure → may increase the illustrated loan at the same affordable EMI",
      "Higher interest rate → typically lowers the illustrated loan for the same EMI",
    ],
    beginnerMistakes: [
      "Treating the illustrated loan as a lender sanction or credit decision",
      "Treating the affordability ratio as a universal bank or RBI rule",
      "Ignoring that property value and loan-to-value limits are not modelled here",
      "Assuming an illustrated amount equals comfortable household affordability",
    ],
